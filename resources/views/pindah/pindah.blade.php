...
@section('content')
    ...
    <div class="modal fade text-left" id="modal-tambah" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
        ...
        <div class="modal-dialog modal-md" role="document">
            <form action="{{ route('tambah_pindah') }}" enctype="multipart/form-data" method="post">
                @csrf
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="">Alamat Lama</label>
                                    <input type="text" name="alamat_lama" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <label for="">Alamat Baru</label>
                                    <input type="text" name="alamat_baru" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="form-group">
    ...
    @foreach ($datas as $d)
        <div class="modal fade text-left" id="modal-edit{{ $d->id }}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-md" role="document">
                <form action="{{ route('edit_pindah') }}" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myModalLabel1">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="">Alamat Lama</label>
                                        <input value="{{ $d->alamat_lama }}" type="text" name="alamat_lama" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="">Alamat Baru</label>
                                        <input value="{{ $d->alamat_baru }}" type="text" name="alamat_baru" class="form-control">
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
